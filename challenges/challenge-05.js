...
var myArray = ['Renan', 18, null, { a: 1 } ,function(){}];
...
var myArrat2 = ['Ninja', 52.4, true, [1,2, 'Daciuk'], { b: 2}];
...
var bookName = 'Introdução HTML5'
console.log('O livro ' + bookName + ' tem ' + book(bookName).quantidadePaginas + ' páginas!' );

/*
Ainda com a função acima, imprima o nome do autor de um livro qualquer, usando
a frase: "O autor do livro [NOME_DO_LIVRO] é [AUTOR]." */
